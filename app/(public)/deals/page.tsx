...
//         if (typeof sale.sold !== 'number' || typeof sale.total !== 'number' || sale.total <= 0) {
//           console.warn(`Invalid sale data for ${sale.title}: sold=${sale.sold}, total=${sale.total}`);
//           newTimeLeft[sale.id] = 'Invalid';
//           return;
//         }
...
//                   <span>{sale.total > 0 ? Math.round((sale.sold / sale.total) * 100) : 0}% claimed</span>
//                 </div>
//                 <Progress
//                   value={sale.total > 0 ? (sale.sold / sale.total) * 100 : 0}
//                   max={100}
//                   className="h-2"
//                 />
//               </div>
