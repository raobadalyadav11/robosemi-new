            ...
            return (
              <Card key={index} className="card-hover group relative overflow-hidden">
                ...
                <CardContent className="relative p-8 space-y-6">
                  <div className="flex items-center gap-4">
                    <div
                      className={`p-4 rounded-2xl bg-gradient-to-br ${initiative.color} shadow-lg`}
                    >
      ...
      <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
        <CardContent className="p-8 text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
              Partner with us to create innovative solutions that benefit both business and
              the planet. Together, we can build a more sustainable future.
            </p>
          </div>
