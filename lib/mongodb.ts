...
const MONGODB_URI = process.env.MONGODB_URI || "mongodb+srv://officialsponza:officialsponza@sponza.4x2civr.mongodb.net/robosemi?retryWrites=true&w=majority&appName=robosemi";
